...
String inputpath="./TestInput/Controller.xlsx";
String writeresult="./TestOutput/keywordResults.xlsx";
...
res=FunctionLibrary.branchCreation("ameerpet25", "Hyderabad2", "srnagar", "12340", 1, 2, 2);
TakeScreenShot.screenShot(driver, "BranchCreation");
test.log(LogStatus.INFO, description);
break;
case "UPDATEBRANCH":
	FunctionLibrary.navigatebranches();
	res=FunctionLibrary.branchUpdation("hitechcity", "Madhapur");
